...
手动提升的规则会：
1. 使用较低的基础置信度（0.7-0.85）
2. 标记来源为 `manual_promotion`
3. 将相关冲突标记为已提升
...
```python
{
    ...
    "total_conflicts": 42,
    "average_daily": 6.0,
    "change_rate_percent": -15.5,  # 负值表示冲突减少
    "daily_trend": [
        {"date": "2025-12-01", "total": 8, "by_type": {...}},
        {"date": "2025-12-02", "total": 7, "by_type": {...}},
        # ...
    ],
    "most_common_type": "rule_low_llm_consistent",
    "most_affected_language": "python"
}
```
